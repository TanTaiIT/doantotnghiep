     ...
     <!-- Navigation -->
            ...
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="m_2"><a href="{{route('getLogout')}}"><i class="fa fa-lock"></i> Logout</a></li>	
	        		</ul>
	      		</li>
			</ul>
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="{!! asset('layout_admin/css/clndr.css')!!}" type="text/css" />
			<script src="{!! asset('layout_admin/js/underscore-min.js')!!}" type="text/javascript"></script>
			<script src= "{!! asset('layout_admin/js/moment-2.2.1.js')!!}" type="text/javascript"></script>
			<script src="{!! asset('layout_admin/js/clndr.js')!!}" type="text/javascript"></script>
			<script src="{!! asset('layout_admin/js/site.js')!!}" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="{!! asset('layout_admin/css/jqvmap.css')!!}" rel='stylesheet' type='text/css' />
<script src="{!! asset('layout_admin/js/jquery.vmap.js')!!}"></script>
<script src="{!! asset('layout_admin/js/jquery.vmap.sampledata.js')!!}" type="text/javascript"></script>
<script src="{!! asset('layout_admin/js/jquery.vmap.world.js')!!}" type="text/javascript"></script>
