					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('themcat')}}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tên Loại <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control"  name="ten" placeholder="Nhập tên loại sản phẩm">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<textarea type="text" class="form-control" name="mota" required="required" id="ckeditor"  placeholder="Mô tả"></textarea>
											</div>
										</div>
										<div class="item form-group">
