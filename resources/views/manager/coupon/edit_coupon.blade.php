					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="{{URL::to('/update_coupon/'.$coupon->coupon_id)}}" method="post">
										@csrf
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="coupon_name" value="{{$coupon->coupon_name}}" class="form-control" required="required">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												 <input type="text" required="required" value="{{$coupon->coupon_code}}" name="coupon_code" class="form-control">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												 <input type="number" name="coupon_time" value="{{$coupon->coupon_time}}" class="form-control" id="exampleInputEmail1" >
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												 <input type="text"  name="coupon_number" value="{{$coupon->coupon_number}}" class="form-control" required="required" >
											</div>
										</div>
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Ngày bắt đầu</label>
											<div class="col-md-6 col-sm-6 ">
												 <input type="text" name="coupon_date_start" value="{{$coupon->start_day}}" id="start_coupon" class="form-control" required="required">
											</div>
										</div>
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Ngày kết thúc</label>
											<div class="col-md-6 col-sm-6 ">
												 <input type="text" name="coupon_date_end" value="{{$coupon->end_day}}" id="end_coupon" required="required" class="form-control">
											</div>
										</div>
