					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{route('store_po',$chinh->policy_id)}}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tiêu đề <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text"  class="form-control" value="{{$chinh->title}}" name="title">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea type="text" class="form-control" id="ckeditor1" name="content"> {{$chinh->content}}</textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Tóm tắt</label>
											<div class="col-md-6 col-sm-6 ">
												<textarea type="text" class="form-control" id="ckeditor" name="sumary">{{$chinh->sumary}}</textarea>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 text-center">
					                             ...
					                             <img src="{{URL::to('uploads/chinhsach/'.$chinh->image)}}" id="imgPre" class="img-thumbnail cover" width="300px"/> <input type="file" name="image" id="ful" value="{{$chinh->image}}" >
					                             </span>
											</div>
										</div>
